...
| 파일 | 내용 | 용도 |
|---|---|---|
| `sector_etf.pkl` | 11개 섹터 ETF 12개월 수익률 (indmom) | 99_analyze 섹터 분석 |
| `ff_factors_daily.csv` | FF5 + MOM 일별 | CAPM α 회귀 (02b §5, 99_analyze) |
| `ff3_monthly.csv` | FF3 월별 | BL Q 변형 슬롯 `q_ff3_paper` (미주류) |
| `ff5_monthly.csv` | FF5 + MOM 월별 | 99_analyze alpha decomposition (6-factor 회귀) |
...
├── ff3_monthly.csv         # FF3 월별 — BL Q 변형 슬롯
├── ff5_monthly.csv         # FF5+MOM 월별 — 99_analyze alpha decomposition
