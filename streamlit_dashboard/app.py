...
render_subheader(
    ...
    title_ko="변동성 인지 적응 펀드",
    description=(
        "변동성을 예측해 그에 맞춰 자산 배분을 조정하는 가상 펀드입니다. "
        "매 시점의 운용 결정 시 그 시점 이전 데이터만 사용하는 **Walk-forward 방식** 으로 "
        "전체 16년 (2010-2025) 운용. "
        "**TEST 168m** (2010-2023) 에서는 시장보다 우수한 성과를 보였으며, "
        "**Hold Out 24m** (2024-2025) AI 빅테크 집중 상승 시기에는 분산 운용 특성상 일시 부진했습니다."
    ),
)
